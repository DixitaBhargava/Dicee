...
//  Dicee
//
//  Created by Dixita Bhargava on 05/07/20.
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func createPlane(withPlaneAnchor planeAnchor: ARPlaneAnchor) -> SCNNode {
        ...
        planeNode.position = SCNVector3(CGFloat(planeAnchor.center.x), CGFloat(0), CGFloat(planeAnchor.center.z))
